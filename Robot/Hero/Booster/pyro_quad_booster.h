...
struct quad_booster_moduleparams
{
    using CmdType    = quad_booster_cmd_t;
    using ModuleDeps = quad_deps_t;
    using ModuleCtx  = booster_ctx_t;
};
...
class quad_booster_t final
    : public module_base_t<quad_booster_t, quad_booster_moduleparams>
{
    friend class module_base_t<quad_booster_t, quad_booster_moduleparams>;
