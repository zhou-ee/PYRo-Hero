...
class mec_chassis_t final
    : public module_base_t<mec_chassis_t, MecChassisModuleParams>
{
    friend class module_base_t<mec_chassis_t, MecChassisModuleParams>;
  ...
  public:
    ...
    [[nodiscard]] MecChassisModuleParams::ModuleCtx get_ctx();
