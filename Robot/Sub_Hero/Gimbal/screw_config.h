...
constexpr float PITCH_DEADBAND_NORMAL_RADPS   = 0.003f; // 常规模式速度死区
constexpr float PITCH_BUFFER_NORMAL_RADPS   = 0.0015f; // 常规模式速度缓冲区
...
// 限位与偏置
// =========================================================
constexpr float PITCH_MIN_RELATIVE_RAD   = -0.75f; // Pitch 轴最小角度 (rad)
constexpr float PITCH_MAX_RELATIVE_RAD   = 0.15f;  // Pitch 轴最大角度 (rad)
