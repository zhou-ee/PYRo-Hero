...
// 4. 参数聚合类型
// =========================================================
struct QuadBoosterModuleParams
{
...
class quad_booster_t final
    : public module_base_t<quad_booster_t,QuadBoosterModuleParams>
{
    friend class module_base_t<quad_booster_t, QuadBoosterModuleParams>;
